    ...
    <>
      ...
      <div className="w-full max-w-[500px] py-[20px] px-[10px] min-[430px]:p-[30px] bg-white rounded-md shadow-md">
        <div className='max-w-[450px]'>
          ...
          <div className="mt-[120px] mx-0 mb-0 max-w-[450px]">
            <div className="flex justify-between items-center max-w-[450px]">
              <div>
                <textarea
                  type="text"
                  id="input"
                  placeholder="Enter your message"
                 className='w-[70%] h-[58px] pl-[36px] outline-none border-none bg-gray-300 box-border rounded-[5px]'
                />
              </div>
